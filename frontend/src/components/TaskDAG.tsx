...
const DAG_EDGES: [TaskType, TaskType][] = [
  ...
  ['Patient Demographics', 'Patient Variant Occurrences'],
...
const TASK_DESCRIPTIONS: Record<TaskType, string> = {
  ...
  'Patient Extraction': 'Identifies patients, assigns identifiers and proband status, and groups them into families',
  'Patient Demographics': 'Attaches demographic and clinical details (sex, ages, race, ethnicity, affected status, etc.) to each identified patient',
