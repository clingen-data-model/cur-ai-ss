"""squashed initial schema with all tables and columns

Revision ID: 0001_squashed_initial_schema
Revises:
Create Date: 2026-05-27 00:39:54.498071
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('agent_runs', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_agent_runs_git_hash'), ['git_hash'], unique=False
        )
        batch_op.create_index('ix_agent_runs_updated_at', ['updated_at'], unique=False)
    ...
    with op.batch_alter_table('conversations', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_conversations_paper_id'), ['paper_id'], unique=True
        )
    ...
    with op.batch_alter_table('families', schema=None) as batch_op:
        batch_op.create_index('ix_families_paper_id', ['paper_id'], unique=False)
    ...
    with op.batch_alter_table('variants', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_variants_agent_run_id'), ['agent_run_id'], unique=False
        )
    ...
    with op.batch_alter_table('patients', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_patients_agent_run_id'), ['agent_run_id'], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column('de_novo', sa.Boolean(), nullable=False),
        ...
        sa.Column('de_novo_evidence', sa.JSON(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('skip_successors', sa.Boolean(), server_default='0', nullable=False),
        sa.Column('conversation_id', sa.String(), nullable=True),
    ...
    with op.batch_alter_table('tasks', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_tasks_agent_run_id'), ['agent_run_id'], unique=False
        )
        batch_op.create_index(
            'ix_tasks_dedup',
            [
        ...
        batch_op.create_index(
            batch_op.f('ix_tasks_paper_id'), ['paper_id'], unique=False
        )
        batch_op.create_index(
            'ix_tasks_paper_id_status', ['paper_id', 'status'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_tasks_patient_id'), ['patient_id'], unique=False
        )
        batch_op.create_index(
            batch_op.f('ix_tasks_phenotype_id'), ['phenotype_id'], unique=False
        )
        ...
        batch_op.create_index(
            batch_op.f('ix_tasks_variant_id'), ['variant_id'], unique=False
        )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('tasks', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_tasks_variant_id'))
        batch_op.drop_index(batch_op.f('ix_tasks_type'))
        batch_op.drop_index(batch_op.f('ix_tasks_status'))
        batch_op.drop_index(batch_op.f('ix_tasks_phenotype_id'))
        batch_op.drop_index(batch_op.f('ix_tasks_patient_id'))
        batch_op.drop_index('ix_tasks_paper_id_status')
        ...
        batch_op.drop_index(batch_op.f('ix_tasks_agent_run_id'))
    ...
    with op.batch_alter_table('patients', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_patients_agent_run_id'))
    ...
    with op.batch_alter_table('variants', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_variants_agent_run_id'))
    ...
    with op.batch_alter_table('families', schema=None) as batch_op:
        batch_op.drop_index('ix_families_paper_id')
    ...
    op.drop_table('genes')
    with op.batch_alter_table('agent_runs', schema=None) as batch_op:
        batch_op.drop_index('ix_agent_runs_updated_at')
        batch_op.drop_index(batch_op.f('ix_agent_runs_git_hash'))
