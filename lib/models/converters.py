...
def segregation_analysis_computed_to_db(
    ...
    return SegregationAnalysisComputedDB(
        ...
        affected_count=output.affected_count.value,
        affected_count_reasoning=output.affected_count.model_dump(),
        unaffected_count=output.unaffected_count.value,
        unaffected_count_reasoning=output.unaffected_count.model_dump(),
