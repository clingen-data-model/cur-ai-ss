...
from lib.ui.api import get_paper_patients
...
with center:
    ...
    # -----------------------------
    patient_resps = get_paper_patients(paper_query_params.paper_id)
    patients: list[PatientInfo] = [patient_resp_to_pydantic(pr) for pr in patient_resps]
