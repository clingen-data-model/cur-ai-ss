...
from lib.agents.variant_extraction_agent import VariantExtractionOutput, GenomeBuild


CLINGEN_ALLELE_REGISTRY_ENDPOINT = (
...
def gnomad_style_id_from_variant_validator(variant_description: str) -> str | None:
    ...
    endpoint = VV_VARIANT_VALIDATOR_ENSEMBL_ENDPOINT if variant_description.strip().startswith(("ENST", "ENSP", "ENSG")) else VV_VARIANT_VALIDATOR_ENDPOINT
